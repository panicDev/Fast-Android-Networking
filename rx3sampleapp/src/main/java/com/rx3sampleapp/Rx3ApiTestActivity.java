...
import com.rx3androidnetworking.Rx3ANRequest;
...
public class Rx3ApiTestActivity extends AppCompatActivity {

    private static final String TAG = Rx3ApiTestActivity.class.getSimpleName();
    ...
    public void getAllUsers(View view) {
        Rx3AndroidNetworking.get(ApiEndPoint.BASE_URL + ApiEndPoint.GET_JSON_ARRAY)
    ...
    public void getAnUser(View view) {
        Rx3AndroidNetworking.get(ApiEndPoint.BASE_URL + ApiEndPoint.GET_JSON_OBJECT)
    ...
    public void checkForHeaderPost(View view) {
        ...
        Rx3ANRequest.PostRequestBuilder postRequestBuilder = Rx3AndroidNetworking.post(ApiEndPoint.BASE_URL + ApiEndPoint.CHECK_FOR_HEADER);
    ...
    public void createAnUser(View view) {
        Rx3AndroidNetworking.post(ApiEndPoint.BASE_URL + ApiEndPoint.POST_CREATE_AN_USER)
    ...
    public void downloadFile(final View view) {
        ...
        Rx3AndroidNetworking.download(url, Utils.getRootDirPath(getApplicationContext()), "file1.zip")
                .build()
                .setAnalyticsListener(new AnalyticsListener() {
                    @Override
                    public void onReceived(long timeTakenInMillis, long bytesSent, long bytesReceived, boolean isFromCache) {
    ...
    public void downloadImage(final View view) {
        ...
        Rx3AndroidNetworking.download(url, Utils.getRootDirPath(getApplicationContext()), "image1.png")
                .build()
                .setAnalyticsListener(new AnalyticsListener() {
                    @Override
                    public void onReceived(long timeTakenInMillis, long bytesSent, long bytesReceived, boolean isFromCache) {
    ...
    public void uploadImage(final View view) {
        Single<JSONObject> single = Rx3AndroidNetworking.upload(ApiEndPoint.BASE_URL + ApiEndPoint.UPLOAD_IMAGE)
    ...
    public void loadImage(View view) {
        ...
        Rx3AndroidNetworking.get(URL_IMAGE)
